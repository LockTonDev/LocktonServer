module.exports = Object.freeze({
   ...
   * - :user_uuid 사용자 KEY
   */
  INSURANCE_LAW_RATE_TOP: `SELECT base_year,
      ver,
      user_cd,
      business_cd,
      insr_st_dt,
  ...
  INSURANCE_STATUS: `
    ...
    `,
  /**
   * [보험DB - LAW] 보험 데이터 조회 엑셀용
   *
   */
  INSURANCE_LAW_EXCEL_LIST: `
   ...
   * - :user_uuid 사용자 KEY
   */
  INSURANCE_LAW_LIST: `SELECT A.insurance_uuid
    , A.business_cd
    , A.user_cd
    , A.user_uuid
    , A.user_nm
...
`,
   ...
   * [보험DB - LAW] 입력
   */
  INSERT_LAW_INSURANCE: `INSERT INTO tlaw0030a
            (insurance_uuid,
             user_uuid,
             insurance_no,
             business_cd,
...
VALUES      ( UUID_V4(), ?, ?, ?, ?, 
   ...
   */
  UPDATE_INSURANCE: `
    /* AdminMapper.UPDATE_LAW_INSURANCE */    
    UPDATE tlaw0030a
    SET    insurance_no = ?,
          business_cd = ?,
          user_cd = ?,
   ...
   * - :user_uuid 사용자 KEY
   */
  SELECT_INSURANCE_LAW_TRX_DATA_LIST: `
      SELECT A.insurance_uuid
            , A.business_cd
            , A.user_cd
            , A.user_uuid
   ...
   * [보험DB - LAW] 삭제
   */
  DELETE_LAW_INSURANCE: `
      DELETE FROM tlaw0030a WHERE insurance_uuid = ? AND user_uuid = ?
    `,
   ...
   * - :insurance_uuid 보험 KEY
   */
  RENEWAL_INSURANCE_LAW_INFO: `SELECT A.insurance_uuid
    ,A.user_uuid
    ,A.business_cd
    ,A.user_cd
    ,A.user_id
   ...
   * - :user_uuid 사용자 KEY
   */
  RENEWAL_INSURANCE_LAW_LIST: `SELECT A.insurance_uuid
    , A.business_cd
    , A.user_cd
    , A.user_uuid
    , A.user_nm
   ...
   * [갱신DB - LAW] 입력
   */
  INSERT_RENEWAL_LAW_INSURANCE: `
      INSERT INTO tlaw0031a
            (insurance_uuid,
             user_uuid,
             insurance_no,
             business_cd,
...
VALUES      ( UUID_V4(), ?, ?, ?, ?,
   ...
   * [갱신DB - LAW] 삭제
   */
  DELETE_RENEWAL_LAW_INSURANCE: `
      /* AdminMapper.DELETE_RENEWAL_INSURANCE */    
      DELETE FROM tlaw0031a WHERE insurance_uuid = ?
    `,

  /**
   * [변경요청DB - LAW] 목록 조회
   */
  SELECT_APPLY_LAW_INSURANCE_LIST: `
      SELECT 
        a.*,
        (
          select 
      ...
      FROM 
        TLAW0040A a LEFT OUTER JOIN TLAW0030A b 
